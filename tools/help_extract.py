...
OUT_DIR = os.path.join(PROJECT_ROOT, *HELP_DIR.split("/"))
...
def main():
    ...
    # Filename from core.helptext, not spelled out again here:
    # the loader builds it there and setup.py checks for it.
    out_path = os.path.join(args.out,
                            os.path.basename(help_file(args.lang)))
