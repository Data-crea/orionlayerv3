...
```bash
python tools/smoke_test.py             # everything — 251 checks, ~72 s
python tools/smoke_test.py --fast      # the commit gate's 244, ~32 s
...
251 checks, headless, no orion2re needed. **The count must not go
