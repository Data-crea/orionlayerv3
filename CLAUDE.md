...
```bash
python tools/smoke_test.py             # everything — 303 checks, ~72 s
python tools/smoke_test.py --fast      # the commit gate's 296, ~32 s
...
303 checks, headless, no orion2re needed. **The count must not go
