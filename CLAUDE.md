...
```bash
python tools/smoke_test.py             # everything — 336 checks, ~200 s
python tools/smoke_test.py --fast      # the commit gate's 326, ~95 s
...
336 checks, headless, no orion2re needed. **The count must not go
