...
```bash
python tools/smoke_test.py             # everything — 337 checks, ~200 s
python tools/smoke_test.py --fast      # the commit gate's 327, ~95 s
...
337 checks, headless, no orion2re needed. **The count must not go
