...
```bash
python tools/smoke_test.py             # everything — 280 checks, ~72 s
python tools/smoke_test.py --fast      # the commit gate's 273, ~32 s
...
280 checks, headless, no orion2re needed. **The count must not go
