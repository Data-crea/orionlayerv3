...
```bash
python tools/smoke_test.py             # everything — 278 checks, ~72 s
python tools/smoke_test.py --fast      # the commit gate's 271, ~32 s
...
278 checks, headless, no orion2re needed. **The count must not go
