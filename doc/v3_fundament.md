...
|---|---|---:|---|---|
| [`fundament/01-decisions-layout-structure-and-data.md`](fundament/01-decisions-layout-structure-and-data.md) | **Layout, structure and data** | 28 | 1-19, 34, 37-38, 50-51, 57, 70, 72-73 | How the HD client is laid out and where its data lives — the section's own preamble, Layout and coordinates, Structure, Data and resources — and decisions 72 and 73, the player's mod folder and its texts. |
...
| [`fundament/04-decisions-screen-artwork-and-markings.md`](fundament/04-decisions-screen-artwork-and-markings.md) | **Screen artwork and markings** | 35 | 55-56, 58, 61, 63-69, 71 | One screen, one frame image: the per-screen artwork decisions, the display settings, and the marking vocabulary — and decision 71, which replaces the frames with one frameless style drawn in code. |
