...
|---|---|---:|---|---|
| [`fundament/01-decisions-layout-structure-and-data.md`](fundament/01-decisions-layout-structure-and-data.md) | **Layout, structure and data** | 27 | 1-19, 34, 37-38, 50-51, 57, 70, 72 | How the HD client is laid out and where its data lives — the section's own preamble, Layout and coordinates, Structure, Data and resources — and decision 72, the player's mod folder. |
