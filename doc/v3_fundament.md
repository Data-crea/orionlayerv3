...
|---|---|---:|---|---|
| [`fundament/01-decisions-layout-structure-and-data.md`](fundament/01-decisions-layout-structure-and-data.md) | **Layout, structure and data** | 24 | 1-19, 34, 37-38, 50-51, 57, 70 | How the HD client is laid out and where its data lives — the section's own preamble, Layout and coordinates, Structure, Data and resources. |
